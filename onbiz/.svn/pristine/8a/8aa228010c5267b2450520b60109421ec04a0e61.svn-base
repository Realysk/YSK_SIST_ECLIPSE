...
<form id="frm01"  method="post">
	    <input name="ordercom_name" value="" placeholder="제목" />
	    <input name="ordercom_kind" value=""  placeholder="작성자" />
	    <button  type="submit">Search</button>
	    <button Wid="regBtn" type="button">등록</button>
                                ...
                                <div class="card-body">
                                 <form id ="frm01" method ="post">
									<c:set var="today" value="<%=new Date()%>"/>
                                        ...
                                        <label class="small mb-1" >담당자</label> <span>${login_User}님</span><br>
                                        <hr>
                                       <span class="small mb-1" >제목 </span><input class ="form-control form-control-sm" type = "text" value ="" ><br>
                                         <span class="small mb-1" >결재말료요청일</span> <input  id="datepicker"class ="form-control form-control-sm" type = "text" value ="" ><br>
                                       <span class="small mb-1" >시작일</span><input  id="datepicker" class ="form-control form-control-sm" type = "text" value ="" ><br>
                                        <span class="small mb-1" >종료일</span><input id="datepicker"  class ="form-control form-control-sm"  type = "text" value ="" ><br>
                                
                                        <span class="small mb-1" >요청예산</span> <input class ="form-control form-control-sm" type = "text" value ="" ><br>
                                        
                                            <span class="small mb-1" >발주처</span><select class= "custom-select custom-select-sm form-control form-control-sm" >
                                            <c:forEach var="order" items="${ordercom}">
                                            <option>${order.ordercom_name}</option>
                                            </c:forEach>
                                            </select><br>
                                    <hr>
                                ...
                                <div class="card-body">
                                    <div class="chart-pie pt-4">
                                        ...
                                        <c:forEach var="emplist" items="${emp}">
                                            <option>${emplist.emp_korname}</option>
                                            </c:forEach></select> <p>+</p><br>
