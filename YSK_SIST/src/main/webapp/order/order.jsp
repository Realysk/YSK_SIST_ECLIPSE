   ...
   <section>
   		<form id="frm01" action="#" method="post">
			...
			<fieldset style="width:45%; float:left;">
				<table class="cart-wrapper" border>
					<tr><th colspan="2"> 할인 적용 </th></tr>
					<tr><th style="text-align:left;"> 적립금 <span style="font-size:12px;">(보유 적립금 : 0 원)</span> </th><td style="text-align:right;"> 0 원 </td></tr>
					<tr><th style="text-align:left;"> 캐시 <span style="font-size:12px;">(보유 캐시 : 0 원)</span> </th><td style="text-align:right;"> 0 캐시 </td></tr>
				</table>
				<table class="cart-wrapper" border>
					<tr><th colspan="2"> 최종 결제 정보 </th></tr>
					<tr><th style="text-align:left;"> 상품 금액 </th><td style="text-align:right;"> 0 원 </td></tr>
					<tr><th style="text-align:left;"> 할인 금액 </th><td style="text-align:right;"> 0 원 </td></tr>
					<tr><th style="text-align:left;"> 최종 금액 </th><td style="text-align:right;"> 0 원 </td></tr>
				</table>
			</fieldset>
			<fieldset style="width:45%; float:right;">
				...
				<label>
	   				<input type="submit" value="최종주문" style="margin-top:5%; margin-bottom:5%; font-size:20px; float:right;"/>
	   				<input type="submit" value="주문취소" style="margin-top:5%; margin-bottom:5%; font-size:20px; float:left;"/>
	   			</label>
	   		</div>
		</form>
