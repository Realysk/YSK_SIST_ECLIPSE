 ...
 */
@WebServlet(name = "schMember2.do", urlPatterns = { "/schMember2.do" })
public class A28_AjaxController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private CommonService service;
	public A28_AjaxController() {
		super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (proc == null) {
			...
			response.sendRedirect("a14_mvc\\a08_mvc_ajax.jsp");
