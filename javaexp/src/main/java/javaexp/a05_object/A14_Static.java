...
public class A14_Static {
	...
	/*
	 # 정적멤버 static 활용하기
	 	...
	 	2. static이 선언된 멤버는 하나의 클래스에서 만들어진 모든 객체들의 데이터나 기능을 공유할 수 있다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		  ex) Bear name(이름) 일반 변수 : 먹은 빵의 갯수. static 변수로 전체 남은 빵의 갯수 1) 초기 전체 빵의 갯수를
		  할당.
		 	*/
				Bear.REST_BREAD=20;
				...
				b2.eat();
				b2.eat();
				System.out.println("현재 남은 빵의 갯수 : " + Bear.REST_BREAD);
			/*
		  
		 
		  2) 각자가 빵을 먹을 때 각자의 먹은 갯수 증가, static 변수의 빵의 갯수 감소.
...
//		c1.money2=1000;
		...
		// static 변수나 메서드는 공유하는 영역이기 때문에 굳이 객체의 참조변수로 쓰지 않고 클래스명.static멤버로 사용한다.
