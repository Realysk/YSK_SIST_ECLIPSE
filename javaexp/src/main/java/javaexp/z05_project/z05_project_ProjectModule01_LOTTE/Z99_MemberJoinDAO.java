package javaexp.z05_project.z05_project_ProjectModule01_LOTTE;
...
public class Z99_MemberJoinDAO {
    ...
    ArrayList<Z99_Member> members = new ArrayList<>();
    
    
    // 생성자로 초기 데이터 입력
    public Z99_MemberJoinDAO() {
    	
        members.add(new Z99_Member("hong1", "1111", "홍길동", "010-7777-8888", 
        		"ssangyong@naver.com", "서울 특별시", "02-555-4468"));
        members.add(new Z99_Member("kong2", "2222", "김길동", "010-4855-1234", 
        		"kong2@gmail.com", "부산 광역시", "031-346-4642"));
        members.add(
        		new Z99_Member("cong3", "3333", "최길동", "010-1578-9710", 
    ...
    private void SelectMember() {
        Iterator<Z99_Member> ite = members.iterator();
    ...
    private void MemberJoin() {
        ...
        while(true) {
            ...
            if(idCheck(id)) {
                ...
                members.add(new Z99_Member(id, pw, name, hp, email, address, tel));
                System.out.println("\n [" + id + "]님 가입을 축하드립니다!\n");
                break;
            } else if(ok.equals("N")) {
    ...
    private Z99_Member FindById(String id) {
        for(Z99_Member m : members) {
