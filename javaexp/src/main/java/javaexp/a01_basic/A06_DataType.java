	...
	public static void main(String[] args) {
		...
		# 기본 데이터 타입
			1. 정수, 실수, 문자, 논리 리터럴(할당되는 실제 상수 데이터)을 직접 저장하는 타입을 말한다.
				25 (리터럴 상수)
			2. 메모리의 최소 기억단위인 bit(0/1)가 8개 모여 byte가 형성되어 범위를 설정한다.
			3. 유형
				1) 정수형
					byte (1byte) -128~127
					char (2byte) 0~65535 유니코드 문자
						char c1 = 'A';
						char c2 = (char)25;	정수형 25번째 코드 값이 c2변수에 할당된다.
		...
		*/
//			ex) 기본 데이터 유형의 이름과 타입에 맞게 데이터를 선언과 할당하여 출력하세요.
//				확인 : 연산자를 이용해서 데이터 할당은 어떤 타입부터 가능한지 확인하세요.
				byte num01 = 25;
				num01 = 127; // MIN / MAX 데이터도 확인
				num01 = -128; // MIN / MAX 데이터도 확인
				System.out.println("byte 데이터 타입 : " + num01);
				short num02 = 32767;
				System.out.println("short 데이터 타입 : " + num02);
				...
				int num04 = 22222222;
//				long num05 = 22222222;
				long num06 = 22222222L;
//				float num07 = 342.278; // 실수형 기본 데이터는 double이기에 할당 X
				float num08 = 342.278F;
